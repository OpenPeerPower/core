...
def gather_requirements_from_manifests(errors, reqs):
    ...
    for domain in sorted(integrations):
        ...
        process_requirements(
            errors, integration.requirements, f"openpeerpower.components.{domain}", reqs
        )
...
def requirements_all_output(reqs):
    ...
    output = [
        "# Open Peer Power Core, full dependency set\n",
        "-r requirements.txt\n",
    ]
...
def requirements_test_all_output(reqs):
    ...
    output = [
        "# Open Peer Power tests, full dependency set\n",
