...
IGNORED_MODULES: Final[list[str]] = [
    ...
    "openpeerpower.components.garmin_connect.*",
    ...
    "openpeerpower.components.home_plus_control.*",
    ...
    "openpeerpower.components.kostal_plenticore.*",
    ...
    "openpeerpower.components.screenlogic.*",
    ...
    "openpeerpower.components.vizio.*",
