...
def validate_integration(config: Config, integration: Integration):
    ...
    needs_unique_id = integration.domain not in UNIQUE_ID_IGNORE and (
        ...
        or "async_step_oppio" in config_flow
    ...
    has_unique_id = (
        ...
        or "self._async_op.dle_discovery_without_unique_id" in config_flow
...
def validate(integrations: Dict[str, Integration], config: Config):
    ...
    config_flow_path = config.root / "openpeerpower/generated/config_flows.py"
