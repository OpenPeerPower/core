...
class LogiCircleFlowHandler(config_entries.ConfigFlow):
    ...
    async def async_step_auth(self, user_input=None):
        ...
        if external_error:
            ...
            self.opp.data[DATA_FLOW_IMPL][DOMAIN][EXTERNAL_ERRORS] = None
    ...
    def _get_authorization_url(self):
        ...
        self.opp.http.register_view(LogiCircleAuthCallbackView())
    ...
    async def _async_create_session(self, code):
        ...
        logi_session = LogiCircle(
            ...
            api_key=api_key,
            redirect_uri=redirect_uri,
            cache_file=self.opp.config.path(DEFAULT_CACHEDB),
        )
        ...
        try:
            ...
            (self.opp.data[DATA_FLOW_IMPL][DOMAIN][EXTERNAL_ERRORS]) = "invalid_auth"
            return self.async_abort(reason="external_error")
        except asyncio.TimeoutError:
            (
                self.opp.data[DATA_FLOW_IMPL][DOMAIN][EXTERNAL_ERRORS]
...
class LogiCircleAuthCallbackView(OpenPeerPowerView):
