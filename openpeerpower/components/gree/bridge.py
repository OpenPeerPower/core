...
class DeviceDataUpdateCoordinator(DataUpdateCoordinator):
    ...
    def __init__(self, opp: OpenPeerPower, device: Device) -> None:
...
class DiscoveryService(Listener):
    ...
    def __init__(self, opp) -> None:
        ...
        opp.data[DOMAIN].setdefault(COORDINATORS, [])
    ...
    async def device_found(self, device_info: DeviceInfo) -> None:
        ...
        coordo = DeviceDataUpdateCoordinator(self.opp, device)
        self.opp.data[DOMAIN][COORDINATORS].append(coordo)
        await coordo.async_refresh()

        async_dispatcher_send(self.opp, DISPATCH_DEVICE_DISCOVERED, coordo)
