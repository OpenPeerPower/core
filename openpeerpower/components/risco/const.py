...
CONF_RISCO_STATES_TO_OP = "risco_states_to_ha"
...
DEFAULT_OPTIONS = {
    ...
    CONF_RISCO_STATES_TO_OP: DEFAULT_RISCO_STATES_TO_HA,
    CONF_OP_STATES_TO_RISCO: DEFAULT_OP_STATES_TO_RISCO,
}
