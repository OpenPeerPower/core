...
from openpeerpower.components.scene import DOMAIN as DOMAIN_SCENE, Scene
from openpeerpower.const import CONF_ADDRESS, CONF_DOMAIN, CONF_ENTITIES, CONF_SCENE
...
def create_lcn_scene_entity(opp, entity_config, config_entry):
...
async def async_setup_entry(opp, config_entry, async_add_entities):
    ...
    for entity_config in config_entry.data[CONF_ENTITIES]:
        if entity_config[CONF_DOMAIN] == DOMAIN_SCENE:
            entities.append(create_lcn_scene_entity(opp, entity_config, config_entry))
