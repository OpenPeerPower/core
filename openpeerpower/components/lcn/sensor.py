...
from openpeerpower.components.sensor import DOMAIN as DOMAIN_SENSOR, SensorEntity
...
def create_lcn_sensor_entity(opp, entity_config, config_entry):
...
async def async_setup_entry(opp, config_entry, async_add_entities):
    ...
    for entity_config in config_entry.data[CONF_ENTITIES]:
        if entity_config[CONF_DOMAIN] == DOMAIN_SENSOR:
            entities.append(create_lcn_sensor_entity(opp, entity_config, config_entry))
