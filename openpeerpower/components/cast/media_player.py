...
@callback
def _async_create_cast_device(opp: OpenPeerPower, info: ChromecastInfo):
...
class CastDevice(MediaPlayerEntity):
    ...
    def __init__(self, cast_info: ChromecastInfo) -> None:
        ...
        self._opp_cast_controller: OpenPeerPowerController | None = None
    ...
    async def async_play_media(self, media_type, media_id, **kwargs):
        ...
        if media_id[0] == "/":
            ...
            config_entry = self.opp.config_entries.async_get_entry(config_entry_id)
