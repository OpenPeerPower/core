...
from openpeerpower.components.camera.const import DOMAIN
from openpeerpower.const import CONF_NAME, CONF_TIMEOUT, CONF_WEBHOOK_ID
...
class PushCamera(Camera):
    ...
    async def async_added_to_opp(self):
        ...
        try:
            self.opp.components.webhook.async_register(
