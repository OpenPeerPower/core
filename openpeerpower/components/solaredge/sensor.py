...
from openpeerpower.const import DEVICE_CLASS_BATTERY, DEVICE_CLASS_POWER
...
async def async_setup_entry(
    ...
    api: Solaredge = opp.data[DOMAIN][entry.entry_id][DATA_API_CLIENT]
...
class SolarEdgeSensorFactory:
    ...
    def __init__(
        self, opp: OpenPeerPower, platform_name: str, site_id: str, api: Solaredge
    ) -> None:
...
class SolarEdgeDataService:
    ...
    def __init__(self, opp: OpenPeerPower, api: Solaredge, site_id: str) -> None:
