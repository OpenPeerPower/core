...
from openpeerpower.helpers.trace import (
    TraceElement,
...
@callback
def automations_with_area(opp: OpenPeerPower, area_id: str) -> list[str]:
...
@callback
def areas_in_automation(opp: OpenPeerPower, entity_id: str) -> list[str]:
