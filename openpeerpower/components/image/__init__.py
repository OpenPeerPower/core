...
from openpeerpower.components.http.static import CACHE_HEADERS
...
class ImageStorageCollection(collection.StorageCollection):
    ...
    async def _process_create_data(self, data: typing.Dict) -> typing.Dict:
        ...
        data["filesize"] = await self.opp.async_add_executor_job(self._move_data, data)
    ...
    async def _change_listener(self, change_type, item_id, data):
        ...
        await self.opp.async_add_executor_job(shutil.rmtree, self.image_dir / item_id)


class ImageUploadView(OpenPeerPowerView):
...
class ImageServeView(OpenPeerPowerView):
