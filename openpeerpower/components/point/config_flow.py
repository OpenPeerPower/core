...
@callback
def register_flow_implementation(opp, domain, client_id, client_secret):
...
class PointFlowHandler(config_entries.ConfigFlow):
    ...
    async def _get_authorization_url(self):
        ...
        self.opp.http.register_view(MinutAuthCallbackView())
    ...
    async def async_step_code(self, code=None):
        ...
        _LOGGER.debug(
            ...
            self.opp.config_entries.flow.async_progress(),
        )
...
class MinutAuthCallbackView(OpenPeerPowerView):
