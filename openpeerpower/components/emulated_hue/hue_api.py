"""Support for a Hue API to control Open Peer Power."""
import asyncio
import hashlib
...
class HueUnauthorizedUser(OpenPeerPowerView):
...
class HueUsernameView(OpenPeerPowerView):
...
class HueAllGroupsStateView(OpenPeerPowerView):
...
class HueGroupView(OpenPeerPowerView):
...
class HueAllLightsStateView(OpenPeerPowerView):
...
class HueFullStateView(OpenPeerPowerView):
...
class HueConfigView(OpenPeerPowerView):
...
class HueOneLightStateView(OpenPeerPowerView):
...
class HueOneLightChangeView(OpenPeerPowerView):
