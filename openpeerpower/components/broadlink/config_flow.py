...
class BroadlinkFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_dhcp(self, discovery_info):
        ...
        try:
            device = await self.opp.async_add_executor_job(blk.hello, host)
    ...
    async def async_step_user(self, user_input=None):
        ...
        if user_input is not None:
            ...
            try:
                ...
                device = await self.opp.async_add_executor_job(hello)
    ...
    async def async_step_auth(self):
        ...
        try:
            await self.opp.async_add_executor_job(device.auth)
    ...
    async def async_step_unlock(self, user_input=None):
        ...
        if user_input is None:
            ...
            try:
                await self.opp.async_add_executor_job(device.set_lock, False)
