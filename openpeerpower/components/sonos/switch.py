...
from openpeerpower.components.switch import ENTITY_ID_FORMAT, SwitchEntity
from openpeerpower.const import ATTR_TIME
...
async def async_setup_entry(opp, config_entry, async_add_entities):
    ...
    config_entry.async_on_unload(
        async_dispatcher_connect(opp, SONOS_CREATE_ALARM, _async_create_entity)
    )
...
class SonosAlarmEntity(SonosEntity, SwitchEntity):
    ...
    async def async_added_to_opp(self) -> None:
        """Handle switch setup when added to opp."""
    ...
    def alarm(self):
        ...
        return self.opp.data[DATA_SONOS].alarms[self.alarm_id]
    ...
    def async_check_if_available(self):
        ...
        if self.alarm_id in self.opp.data[DATA_SONOS].alarms:
            return True
    ...
    async def async_handle_switch_on_off(self, turn_on: bool) -> None:
        ...
        try:
            ...
            await self.opp.async_add_executor_job(self.alarm.save)
