...
class SonosFavorites:
    ...
    def __init__(self, opp: OpenPeerPower, household_id: str) -> None:
        """Initialize the data."""
        self.opp = opp
    ...
    def async_delayed_update(self, event: SonosEvent) -> None:
        ...
        self._next_update = self.opp.helpers.event.async_call_later(3, self.update)
    ...
    def update(self, now: datetime.datetime | None = None) -> None:
        ...
        dispatcher_send(self.opp, f"{SONOS_HOUSEHOLD_UPDATED}-{self.household_id}")
