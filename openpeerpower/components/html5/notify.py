...
from openpeerpower.components.frontend import add_manifest_json_key
...
from openpeerpower.util import ensure_unique_string
...
class HTML5PushRegistrationView(OpenPeerPowerView):
...
class HTML5PushCallbackView(OpenPeerPowerView):
    """Accepts push registrations from a browser."""
...
class HTML5NotificationService(BaseNotificationService):
    ...
    async def async_dismiss(self, **kwargs):
        ...
        """
        await self.opp.async_add_executor_job(partial(self.dismiss, **kwargs))
