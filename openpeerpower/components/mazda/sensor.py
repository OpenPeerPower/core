...
async def async_setup_entry(opp, config_entry, async_add_entities):
    ...
    client = opp.data[DOMAIN][config_entry.entry_id][DATA_CLIENT]
    ...
    def state(self):
        ...
        return (
            ...
            if fuel_distance_km is None
                ...
                self.opp.config.units.length(fuel_distance_km, LENGTH_KILOMETERS)
            )
        )
...
class MazdaOdometerSensor(MazdaEntity, SensorEntity):
    ...
    def state(self):
        ...
        return (
            ...
            else round(self.opp.config.units.length(odometer_km, LENGTH_KILOMETERS))
        )
