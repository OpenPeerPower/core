...
class UnifiFlowHandler(config_entries.ConfigFlow, domain=UNIFI_DOMAIN):
    ...
    async def async_step_user(self, user_input=None):
        ...
        if not host and await async_discover_unifi(self.opp):
            host = "unifi"
    ...
    async def async_step_site(self, user_input=None):
        ...
        if user_input is not None:
            ...
            if config_entry:
                controller = self.opp.data.get(UNIFI_DOMAIN, {}).get(
                ...
                await self.opp.config_entries.async_reload(config_entry.entry_id)
...
class UnifiOptionsFlowHandler(config_entries.OptionsFlow):
    ...
    async def async_step_init(self, user_input=None):
        ...
        self.controller = self.opp.data[UNIFI_DOMAIN][self.config_entry.entry_id]
