...
class BondBaseLight(BondEntity, LightEntity):
    ...
    def __init__(
        ...
        """Create OPP entity representing Bond light."""
...
class BondFireplace(BondEntity, LightEntity):
    ...
    def __init__(
        ...
        """Create OPP entity representing Bond fireplace."""
    ...
    @property
    def brightness(self) -> int | None:
        """Return the flame of this fireplace converted to OPP brightness between 0..255."""
