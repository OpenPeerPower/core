...
class BondEntity(Entity):
    ...
    def device_info(self) -> DeviceInfo:
        """Get a an OPP device representing this Bond controlled device."""
    ...
    def assumed_state(self) -> bool:
        """Let OPP know this entity relies on an assumed state tracked by Bond."""
    ...
    async def async_added_to_opp(self) -> None:
        ...
        self.async_on_remove(
            async_track_time_interval(
                self.opp, self._async_update_if_bpup_not_alive, _FALLBACK_SCAN_INTERVAL
            )
        )
