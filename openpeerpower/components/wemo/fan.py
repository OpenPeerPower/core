...
async def async_setup_entry.opp, config_entry, async_add_entities):
    ...
    await asyncio.gather(
        *[
            ...
            for device in.opp.data[WEMO_DOMAIN]["pending"].pop("fan")
        ]
    )
...
class WemoHumidifier(WemoSubscriptionEntity, FanEntity):
    ...
    def set_percentage(self, percentage: int) -> None:
        ...
        with self._wemo_exception_op.dler("set speed"):
    ...
    def set_humidity(self, target_humidity: float) -> None:
        ...
        with self._wemo_exception_op.dler("set humidity"):
    ...
    def reset_filter_life(self) -> None:
        ...
        with self._wemo_exception_op.dler("reset filter life"):
