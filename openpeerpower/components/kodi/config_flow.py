...
from openpeerpower.helpers.typing import DiscoveryInfoType, Optional
...
class KodiConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_zeroconf(self, discovery_info: DiscoveryInfoType):
        ...
        try:
            await validate_http(self.opp, self._get_data())
            await validate_ws(self.opp, self._get_data())
        except InvalidAuth:
    ...
    async def async_step_import(self, data):
        ...
        reason = None
        try:
            await validate_http(self.opp, data)
            await validate_ws(self.opp, data)
        except InvalidAuth:
...
class WSCannotConnect(exceptions.OpenPeerPowerError):
