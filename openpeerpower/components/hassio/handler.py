...
class HassIO:
    ...
    @_api_bool
    async def update.opp_api(self, http_config, refresh_token):
        """Update Open Peer Power API data on Hass.io."""
    ...
    @_api_bool
    def update.opp_timezone(self, timezone):
        """Update Open-Peer-Power timezone data on Hass.io.
