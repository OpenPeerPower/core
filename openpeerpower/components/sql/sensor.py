...
from openpeerpower.components.recorder import CONF_DB_URL, DEFAULT_DB_FILE, DEFAULT_URL
from openpeerpower.components.sensor import PLATFORM_SCHEMA
from openpeerpower.const import CONF_NAME, CONF_UNIT_OF_MEASUREMENT, CONF_VALUE_TEMPLATE
