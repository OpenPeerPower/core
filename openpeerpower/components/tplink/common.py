...
async def async_get_discoverable_devices(opp: OpenPeerPower) -> dict[str, SmartDevice]:
...
async def async_discover_devices(
    opp: OpenPeerPower, existing_devices: SmartDevices
) -> SmartDevices:
...
def add_available_devices(
    opp: OpenPeerPower, device_type: str, device_class: Callable
) -> list:
