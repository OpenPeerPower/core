...
def async_register_api(opp: OpenPeerPower) -> None:
    ...
    websocket_api.async_register_command(opp, websocket_ping_node)
    ...
    websocket_api.async_register_command(opp, websocket_refresh_node_cc_values)
    websocket_api.async_register_command(opp, websocket_heal_node)
    ...
    websocket_api.async_register_command(opp, websocket_subscribe_logs)
    ...
    websocket_api.async_register_command(
        opp, websocket_update_data_collection_preference
    )
    websocket_api.async_register_command(opp, websocket_data_collection_status)
    websocket_api.async_register_command(opp, websocket_abort_firmware_update)
    websocket_api.async_register_command(
        opp, websocket_subscribe_firmware_update_status
    )
    websocket_api.async_register_command(opp, websocket_check_for_config_updates)
    websocket_api.async_register_command(opp, websocket_install_config_update)
    opp.http.register_view(DumpView())
    opp.http.register_view(FirmwareUploadView())
...
class FirmwareUploadView(OpenPeerPowerView):
