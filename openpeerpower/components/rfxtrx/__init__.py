...
from openpeerpower.components.binary_sensor import DEVICE_CLASSES_SCHEMA
...
class RfxtrxCommandEntity(RfxtrxEntity):
    ...
    async def _async_send(self, fun, *args):
        rfx_object = self.opp.data[DOMAIN][DATA_RFXOBJECT]
        for _ in range(self.signal_repetitions):
            await self.opp.async_add_executor_job(fun, rfx_object.transport, *args)
