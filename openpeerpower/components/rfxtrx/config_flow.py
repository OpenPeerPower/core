...
class OptionsFlow(config_entries.OptionsFlow):
    ...
    async def _async_replace_device(self, replace_device):
        ...
        entity_registry = await async_get_entity_registry(self.opp)
    ...
    def update_config_data(self, global_options=None, devices=None):
        ...
        self.opp.config_entries.async_update_entry(self._config_entry, data=entry_data)
        self.opp.async_create_task(
            self.opp.config_entries.async_reload(self._config_entry.entry_id)
        )
...
class ConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_validate_rfx(self, host=None, port=None, device=None):
        ...
        success = await self.opp.async_add_executor_job(
