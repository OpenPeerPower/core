    ...
    async def forwarded_middleware(
        ...
        if not use_x_forwarded_for:
            _LOGGER.warning(
                ...
                "This request will be blocked in Open Peer Power 2021.7 unless "
        ...
        if not any(connected_ip in trusted_proxy for trusted_proxy in trusted_proxies):
            _LOGGER.warning(
                ...
                "This request will be blocked in Open Peer Power 2021.7 unless you configure "
                "your HTTP integration to allow this proxy to reverse your Open Peer Power instance",
                connected_ip,
            )
