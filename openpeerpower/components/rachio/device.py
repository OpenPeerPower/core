...
class RachioPerson:
    ...
    async def async_setup(self, opp):
        """Create rachio devices and services."""
        await opp.async_add_executor_job(self._setup, opp)
        can_pause = False
    ...
    def _setup(self, opp):
        ...
        for controller in devices:
            ...
            rachio_iro = RachioIro(opp, rachio, controller, webhooks)
            rachio_iro.setup()
...
class RachioIro:
    ...
    def _init_webhooks(self) -> None:
        ...
        self.opp.bus.listen(EVENT_OPENPEERPOWER_STOP, _deinit_webhooks)
