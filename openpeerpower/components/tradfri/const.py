...
from openpeerpower.components.light import SUPPORT_BRIGHTNESS, SUPPORT_TRANSITION
from openpeerpower.const import CONF_HOST  # noqa: F401 pylint: disable=unused-import
