...
from openpeerpower.const import ATTR_TEMPERATURE, PRECISION_WHOLE, TEMP_CELSIUS
...
class MelissaClimate(ClimateEntity):
    ...
    def fan_mode(self):
        ...
        if self._cur_settings is not None:
            return self.melissa_fan_to_opp(self._cur_settings[self._api.FAN])
    ...
    def hvac_mode(self):
        ...
        return self.melissa_op_to_opp(self._cur_settings[self._api.MODE])
    ...
    async def async_set_fan_mode(self, fan_mode):
        """Set fan mode."""
        melissa_fan_mode = self.opp_fan_to_melissa(fan_mode)
    ...
    async def async_set_hvac_mode(self, hvac_mode):
        ...
        mode = self.opp_mode_to_melissa(hvac_mode)
    ...
    def melissa_fan_to_opp(self, fan):
        ...
        if fan == self._api.FAN_HIGH:
            return FAN_HIGH
        _LOGGER.warning("Fan mode %s could not be mapped t opp", fan)
        return None
