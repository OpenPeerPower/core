...
async def async_setup_entry(opp: OpenPeerPower, entry: ConfigEntry) -> bool:
    ...
    if entry.source == SOURCE_IMPORT:
        ...
        _migrate_old_unique_ids(opp, entry, sensor_def, config_sensors)
    ...
    session = async_get_clientsession(opp, verify_ssl=verify_ssl)
    ...
    remove_stop_listener = opp.bus.async_listen_once(
        EVENT_OPENPEERPOWER_STOP, async_close_session
    )
