...
class AlarmPanel:
    ...
    async def async_save_data(self):
        ...
        if CONF_DEVICES not in self.opp.data[DOMAIN]:
        ...
        self.opp.data[DOMAIN][CONF_DEVICES][self.device_id] = device_data
    ...
    async def async_update_initial_states(self):
        ...
        for sensor_data in self.status.get("sensors"):
            ...
            async_dispatcher_send(self.opp, f"konnected.{entity_id}.update", state)
