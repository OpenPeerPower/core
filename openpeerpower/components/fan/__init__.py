...
class FanEntity(ToggleEntity):
    ...
    async def async_set_speed(self, speed: str):
        ...
        if speed in self.preset_modes:
            ...
            if not hasattr(self.set_preset_mode, _FAN_NATIVE):
                await self.opp.async_add_executor_job(self.set_preset_mode, speed)
                return
        else:
        ...
        await self.opp.async_add_executor_job(self.set_speed, speed)
    ...
    async def async_set_direction(self, direction: str):
        """Set the direction of the fan."""
        await self.opp.async_add_executor_job(self.set_direction, direction)
    ...
    async def async_oscillate(self, oscillating: bool):
        """Oscillate the fan."""
        await self.opp.async_add_executor_job(self.oscillate, oscillating)
