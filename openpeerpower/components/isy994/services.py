...
import openpeerpower.helpers.entity_registry as er
...
def async_setup_services(opp: OpenPeerPower):  # noqa: C901
    ...
    async def _async_send_raw_node_command(call: ServiceCall):
        await opp.helpers.service.entity_service_call(
            async_get_platforms(opp, DOMAIN), "async_send_raw_node_command", call
        )
    ...
    async def _async_get_zwave_parameter(call: ServiceCall):
        await opp.helpers.service.entity_service_call(
            async_get_platforms(opp, DOMAIN), "async_get_zwave_parameter", call
        )
    ...
    async def _async_set_zwave_parameter(call: ServiceCall):
        await opp.helpers.service.entity_service_call(
            async_get_platforms(opp, DOMAIN), "async_set_zwave_parameter", call
        )
...
@callback
def async_unload_services(opp: OpenPeerPower):
