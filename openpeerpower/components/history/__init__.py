...
from openpeerpower.components.recorder import history, models as history_models
...
from openpeerpower.helpers.deprecation import deprecated_class, deprecated_function
...
@deprecated_function("openpeerpower.components.recorder.history.get_significant_states")
...
def state_changes_during_period(opp, start_time, end_time=None, entity_id=None):
    ...
    return history.state_changes_during_period(
        opp, start_time, end_time=None, entity_id=None
    )


@deprecated_function("openpeerpower.components.recorder.history.get_last_state_changes")
def get_last_state_changes(opp, number_of_states, entity_id):
    """Return the last number_of_states."""
    return history.get_last_state_changes(opp, number_of_states, entity_id)


@deprecated_function("openpeerpower.components.recorder.history.get_states")
def get_states(opp, utc_point_in_time, entity_ids=None, run=None, filters=None):
    """Return the states at a specific point in time."""
    return history.get_states(
        opp, utc_point_in_time, entity_ids=None, run=None, filters=None
    )


@deprecated_function("openpeerpower.components.recorder.history.get_state")
def get_state(opp, utc_point_in_time, entity_id, run=None):
    """Return a state at a specific point in time."""
    return history.get_state(opp, utc_point_in_time, entity_id, run=None)
...
@deprecated_class("openpeerpower.components.recorder.models.LazyState")
...
def _entities_may_have_state_changes_after(
    opp: OpenPeerPower, entity_ids: Iterable, start_time: dt
) -> bool:
