...
from openpeerpower.const import ATTR_TEMPERATURE, CONF_NAME, TEMP_CELSIUS
...
async def async_setup_platform(
    ...
    _async_migrate_unique_id(opp, platform_config)
    entities = []
...
def _async_migrate_unique_id(
    opp: OpenPeerPower, platform_config: list[ConfigType]
) -> None:
