...
from openpeerpower.components.media_player import DEVICE_CLASS_TV, MediaPlayerEntity
...
class SamsungTVDevice(MediaPlayerEntity):
    ...
    async def async_play_media(self, media_type, media_id, **kwargs):
        ...
        for digit in media_id:
            await self.opp.async_add_executor_job(self.send_key, f"KEY_{digit}")
            await asyncio.sleep(KEY_PRESS_TIMEOUT, self.opp.loop)
        await self.opp.async_add_executor_job(self.send_key, "KEY_ENTER")
    ...
    async def async_turn_on(self):
        ...
        if self._on_script:
            ...
            await self.opp.async_add_executor_job(self._wake_on_lan)
