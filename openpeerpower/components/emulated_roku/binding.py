"""Bridge between emulated_roku and Open Peer Power."""
import logging
...
class EmulatedRoku:
    ...
    async def setup(self):
        ...
        handler = EventCommandHandler(self.opp)
        ...
        async def emulated_roku_start(event):
            ...
            try:
                ...
                self._unsub_stop_listener = self.opp.bus.async_listen_once(
                    EVENT_OPENPEERPOWER_STOP, emulated_roku_stop
                )
        ...
        if self.opp.state == CoreState.running:
            ...
            self._unsub_start_listener = self.opp.bus.async_listen_once(
                EVENT_OPENPEERPOWER_START, emulated_roku_start
            )
