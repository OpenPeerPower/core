...
TADO_MODES_TO_OP_CURRENT_HVAC_ACTION = {
...
TADO_TO_OP_HVAC_MODE_MAP = {
    value: key for key, value in OP_TO_TADO_HVAC_MODE_MAP.items()
}

TADO_TO_OP_FAN_MODE_MAP = {value: key for key, value in OP_TO_TADO_FAN_MODE_MAP.items()}
...
OP_OFFSET_CELSIUS = "offset_celsius"
TADO_OFFSET_FAHRENHEIT = "fahrenheit"
OP_OFFSET_FAHRENHEIT = "offset_fahrenheit"
TADO_TO_OP_OFFSET_MAP = {
    TADO_OFFSET_CELSIUS: OP_OFFSET_CELSIUS,
    TADO_OFFSET_FAHRENHEIT: OP_OFFSET_FAHRENHEIT,
}
