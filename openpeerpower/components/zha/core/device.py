...
class ZHADevice(LogMixin):
    ...
    @property
    def device_id(self):
        """Return the OPP device registry device id."""
        return self._op_device_id

    def set_device_id(self, device_id):
        """Set the OPP device registry device id."""
    ...
    def update_available(self, available: bool) -> None:
        ...
        if availability_changed and available:
            ...
            self.opp.async_create_task(self._async_became_available())
            return
        ...
        async_dispatcher_send(self.opp, f"{self._available_signal}_entity")
