...
from openpeerpower.config_entries import ConfigEntry, ConfigFlow, OptionsFlow
...
class VerisureConfigFlowHandler(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            ...
            try:
                await self.opp.async_add_executor_job(verisure.login)
    ...
    async def async_step_reauth(self, data: dict[str, Any]) -> FlowResult:
        ...
        self.entry = self.opp.config_entries.async_get_entry(self.context["entry_id"])
        ...
        if user_input is not None:
            ...
            try:
                ...
                self.opp.async_create_task(
                    self.opp.config_entries.async_reload(self.entry.entry_id)
                )
