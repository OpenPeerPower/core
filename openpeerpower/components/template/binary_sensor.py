...
from openpeerpower.components.template import TriggerUpdateCoordinator
...
def _async_create_template_tracking_entities(
    async_add_entities, opp, definitions: list[dict], unique_id_prefix: str | None
):
...
async def async_setup_platform(opp, config, async_add_entities, discovery_info=None):
    ...
    if "coordinator" in discovery_info:
        async_add_entities(
            TriggerBinarySensorEntity(opp, discovery_info["coordinator"], config)
...
class TriggerBinarySensorEntity(TriggerEntity, BinarySensorEntity):
    ...
    def __init__(
        ...
        super().__init__(opp, coordinator, config)
    ...
    def _handle_coordinator_update(self) -> None:
        ...
        self._delay_cancel = async_call_later(
            self.opp, delay.total_seconds(), partial(self._set_state, state)
        )
    ...
    def _set_state(self, state, _=None):
        ...
        self._auto_off_cancel = async_call_later(
            self.opp, auto_off_time.total_seconds(), _auto_off
        )
