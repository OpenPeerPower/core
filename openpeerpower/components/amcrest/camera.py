...
from openpeerpower.components.camera import SUPPORT_ON_OFF, SUPPORT_STREAM, Camera
from openpeerpower.components.ffmpeg import DATA_FFMPEG
from openpeerpower.const import ATTR_ENTITY_ID, CONF_NAME, STATE_OFF, STATE_ON
from openpeerpower.helpers.aiohttp_client import (
...
class AmcrestCam(Camera):
    ...
    async def async_camera_image(self):
        ...
        try:
            ...
            self._snapshot_task = self.opp.async_create_task(self._async_get_image())
    ...
    async def handle_async_mjpeg_stream(self, request):
        ...
        if self._stream_source == "mjpeg":
            ...
            return await async_aiohttp_proxy_web(self.opp, request, stream_coro)
