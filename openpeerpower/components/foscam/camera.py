...
class OppFoscamCamera(Camera):
    ...
    async def async_perform_ptz(self, movement, travel_time):
        ...
        ret, _ = await self.opp.async_add_executor_job(movement_function)
        ...
        ret, _ = await self.opp.async_add_executor_job(
    ...
    async def async_perform_ptz_preset(self, preset_name):
        ...
        ret, _ = await self.opp.async_add_executor_job(preset_function, preset_name)
