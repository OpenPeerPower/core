...
class LIFXManager:
    ...
    def start_discovery(self, interface):
        ...
        lifx_discovery = aiolifx().LifxDiscovery(self.opp.loop, self, **kwargs)
    ...
    def cleanup(self, event=None):
        ...
        for service in [
            ...
            self.opp.services.async_remove(LIFX_DOMAIN, service)
    ...
    async def start_effect(self, entities, service, **kwargs):
        ...
        if service == SERVICE_EFFECT_PULSE:
            effect = aiolifx_effects().EffectPulse(
                ...
                hsbk=find_hsbk(self.opp, **kwargs),
            )
            await self.effects_conductor.start(effect, bulbs)
        elif service == SERVICE_EFFECT_COLORLOOP:
            preprocess_turn_on_alternatives(self.opp, kwargs)
    ...
    def register(self, bulb):
        ...
        self.opp.async_create_task(self.register_new_bulb(bulb))
...
class LIFXLight(LightEntity):
    ...
    async def async_turn_on(self, **kwargs):
        ...
        self.opp.async_create_task(self.set_state(**kwargs))
