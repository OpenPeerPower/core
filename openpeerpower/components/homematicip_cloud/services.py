...
async def _async_activate_vacation(opp: OpenPeerPower, service: ServiceCall) -> None:
...
async def _async_deactivate_eco_mode(opp: OpenPeerPower, service: ServiceCall) -> None:
...
async def _async_deactivate_vacation(opp: OpenPeerPower, service: ServiceCall) -> None:
...
async def _async_dump_hap_config(opp: OpenPeerPower, service: ServiceCall) -> None:
...
async def _async_reset_energy_counter(opp: OpenPeerPower, service: ServiceCall):
...
def _get_home(opp: OpenPeerPower, hapid: str) -> AsyncHome | None:
    """Return a HmIP home."""
