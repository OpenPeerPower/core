    ...
    async def async_setup(self) -> bool:
        ...
        try:
            self.auth = await self.get_auth(
                self.opp, self.config.get(HMIPC_HAPID), self.config.get(HMIPC_PIN)
            )
...
class HomematicipHAP:
    ...
    def async_update(self, *args, **kwargs) -> None:
        ...
        if not self.home.connected:
            ...
            job = self.opp.async_create_task(self.get_state())
    ...
    def async_create_entity(self, *args, **kwargs) -> None:
        ...
        self.opp.async_create_task(self.async_create_entity_lazy(is_device))
    ...
    async def async_connect(self) -> None:
        ...
        while True:
            ...
            try:
                self._retry_task = self.opp.async_create_task(
    ...
    def shutdown(self, event) -> None:
        ...
        """
        self.opp.async_create_task(self.async_reset())
        _LOGGER.debug(
