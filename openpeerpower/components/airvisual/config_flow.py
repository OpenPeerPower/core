...
class AirVisualFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def _async_finish_geography(self, user_input, integration_type):
        ...
        # that it's valid:
        valid_keys = self.opp.data.setdefault("airvisual_checked_api_keys", set())
        valid_keys_lock = self.opp.data.setdefault(
        ...
        if existing_entry:
            self.opp.config_entries.async_update_entry(existing_entry, data=user_input)
