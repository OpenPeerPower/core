...
from openpeerpower.const import CONF_WHITE_VALUE
...
class FibaroLight(FibaroDevice, LightEntity):
    ...
    async def async_turn_on(self, **kwargs):
        ...
        async with self._update_lock:
            await self.opp.async_add_executor_job(partial(self._turn_on, **kwargs))
    ...
    async def async_turn_off(self, **kwargs):
        """Turn the light off."""
        async with self._update_lock:
            await self.opp.async_add_executor_job(partial(self._turn_off, **kwargs))
