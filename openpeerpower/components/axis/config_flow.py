...
from openpeerpower.config_entries import SOURCE_IGNORE
...
class AxisFlowHandler(config_entries.ConfigFlow, domain=AXIS_DOMAIN):
    ...
    async def _create_entry(self):
        ...
        same_model = [
            ...
            for entry in self.opp.config_entries.async_entries(AXIS_DOMAIN)
...
class AxisOptionsFlowHandler(config_entries.OptionsFlow):
    ...
    async def async_step_init(self, user_input=None):
        ...
        self.device = self.opp.data[AXIS_DOMAIN][self.config_entry.unique_id]
