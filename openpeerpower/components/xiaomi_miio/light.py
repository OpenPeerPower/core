...
from openpeerpower.const import ATTR_ENTITY_ID, CONF_HOST, CONF_NAME, CONF_TOKEN
import openpeerpower.helpers.config_validation as cv
from openpeerpower.util import color, dt
...
class XiaomiGatewayBulb(XiaomiGatewayDevice, LightEntity):
    ...
    async def async_turn_on(self, **kwargs):
        ...
        await self.opp.async_add_executor_job(self._sub_device.on)
    ...
    async def async_turn_off(self, **kwargsf):
        ...
        await self.opp.async_add_executor_job(self._sub_device.off)
