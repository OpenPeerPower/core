...
from openpeerpower.config_entries import SOURCE_DISCOVERY, SOURCE_IGNORE, SOURCE_IMPORT
from openpeerpower.const import CONF_IP_ADDRESS, CONF_PASSWORD, CONF_USERNAME
...
async def async_setup_entry(opp, entry, async_add_entities):
    ...
    camera_config_entries = opp.config_entries.async_entries(DOMAIN)
