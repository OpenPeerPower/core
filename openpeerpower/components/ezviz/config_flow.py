...
class EzvizConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    async def _validate_and_create_auth(self, data):
        ...
        try:
            await self.opp.async_add_executor_job(_get_ezviz_client_instance, data)
    ...
    async def _validate_and_create_camera_rtsp(self, data):
        ...
        try:
            ezviz_client = await self.opp.async_add_executor_job(
        ...
        try:
            await self.opp.async_add_executor_job(_test_camera_rtsp_creds, data)
