...
class SnapcastGroupDevice(MediaPlayerEntity):
    ...
    def __init__(self, group, uid_part):
        ...
        group.set_callback(self.schedule_update_op_state)
        self._group = group
...
class SnapcastClientDevice(MediaPlayerEntity):
    ...
    def __init__(self, client, uid_part):
        ...
        client.set_callback(self.schedule_update_op_state)
        self._client = client
    ...
    async def async_join(self, master):
        ...
        master_entity = next(
            entity for entity in self.opp.data[DATA_KEY] if entity.entity_id == master
        )
