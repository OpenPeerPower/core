...
class HKDevice:
    ...
    def add_watchable_characteristics(self, characteristics):
        ...
        self.opp.async_create_task(self.pairing.subscribe(characteristics))
    ...
    async def async_process_entity_map(self):
        ...
        await async_setup_triggers_for_entry(self.opp, self.config_entry)
    ...
    def add_entities(self):
        """Process the entity map and create OPP entities."""
    ...
    def process_new_events(self, new_values_dict):
        """Process events from accessory into OPP state."""
    ...
    async def put_characteristics(self, characteristics):
        ...
        # Feed characteristics back into OPP and update the current state
