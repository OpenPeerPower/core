...
from openpeerpower.components.sensor import DOMAIN as PLATFORM_DOMAIN, ENTITY_ID_FORMAT
from openpeerpower.config_entries import ConfigEntry
from openpeerpower.const import LIGHT_LUX, PERCENTAGE, TEMP_CELSIUS, TEMP_FAHRENHEIT
