...
WebSocketCommandHandler = Callable[
    [OpenPeerPower, "ActiveConnection", Dict[str, Any]], None
]
AsyncWebSocketCommandHandler = Callable[
    [OpenPeerPower, "ActiveConnection", Dict[str, Any]], Awaitable[None]
]
...
ERR_HOME_ASSISTANT_ERROR: Final = "open_peer_power_error"
