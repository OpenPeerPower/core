...
class SmartTubLight(SmartTubEntity, LightEntity):
    ...
    def brightness(self):
        ...
        return self._smarttub_to_opp_brightness(self.light.intensity)

    @staticmethod
    def _smarttub_to_opp_brightness(intensity):
        if intensity in (0, 1):
            return 0
        return round(intensity * 255 / 100)

    @staticmethod
    def _opp_to_smarttub_brightness(brightness):
    ...
    async def async_turn_on(self, **kwargs):
        ...
        intensity = self._opp_to_smarttub_brightness(
