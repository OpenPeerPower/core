...
from openpeerpower.exceptions import MaxLengthExceeded
...
class RegistryEntry:
    ...
    @callback
    def write_unavailable_state(self, opp: OpenPeerPower) -> None:
...
class EntityRegistry:
    ...
    def async_generate_entity_id(
        ...
        while (
            ...
            or not self.opp.states.async_available(test_string)
        ):
            tries += 1
...
@callback
def async_get(opp: OpenPeerPower) -> EntityRegistry:
    """Get entity registry."""
...
@bind_opp
async def async_get_registry(opp: OpenPeerPower) -> EntityRegistry:
    """Get entity registry.
...
@callback
def async_setup_entity_restore(opp: OpenPeerPower, registry: EntityRegistry) -> None:
    ...
    def _write_unavailable_states(_: Event) -> None:
        ...
        existing = set(opp.states.async_entity_ids())
