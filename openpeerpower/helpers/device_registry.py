...
from openpeerpower.exceptions import RequiredParameterMissing
...
class DeviceRegistry:
    ...
    def _async_update_device(
        ...
        *,
        ...
        if (
            ...
            area = self.opp.helpers.area_registry.async_get(
                self.opp
    ...
    async def async_load(self) -> None:
        ...
        async_setup_cleanup(self.opp, self)
...
@callback
def async_get(opp: OpenPeerPower) -> DeviceRegistry:
    """Get device registry."""
...
@bind_opp
async def async_get_registry(opp: OpenPeerPower) -> DeviceRegistry:
    """Get device registry.
...
@callback
def async_setup_cleanup(opp: OpenPeerPower, dev_reg: DeviceRegistry) -> None:
