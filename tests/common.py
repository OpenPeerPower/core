...
class MockGroup(auth_models.Group):
    """Mock a group in Open Peer Power."""
...
class MockUser(auth_models.User):
    """Mock a user in Open Peer Power."""
...
class MockModule:
    ...
    def __init__(
        ...
        self.__name__ = f"openpeerpower.components.{domain}"
        self.__file__ = f"openpeerpower/components/{domain}"
        self.DOMAIN = domain
...
class MockPlatform:
    ...
    __name__ = "openpeerpower.components.light.bla"
    __file__ = "openpeerpower/components/blah/light"
...
def assert_setup_component(count, domain=None):
    ...
    with patch("openpeerpower.config.async_process_component_config", mock_psc):
        yield config
