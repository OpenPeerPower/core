...
@bind_opp
def turn_off(opp, entity_id=ENTITY_MATCH_ALL, transition=None, flash=None):
    """Turn all or specified light off."""
    opp.add_job(async_turn_off, opp, entity_id, transition, flash)


async def async_turn_off(opp, entity_id=ENTITY_MATCH_ALL, transition=None, flash=None):
    """Turn all or specified light off."""
    data = {
        key: value
        for key, value in [
