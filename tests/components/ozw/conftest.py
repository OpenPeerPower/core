...
def mock_install_addon():
    """Mock stop add-on."""
    with patch("openpeerpower.components.oppio.async_stop_addon") as stop_addon:
        yield stop_addon
...
def mock_uninstall_addon():
    ...
    with patch(
        "openpeerpower.components.oppio.async_uninstall_addon"
    ) as uninstall_addon:
...
def mock_get_addon_discovery_info():
    ...
    with patch(
        "openpeerpower.components.oppio.async_get_addon_discovery_info"
