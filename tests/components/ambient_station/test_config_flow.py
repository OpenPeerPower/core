...
from openpeerpower.components.ambient_station import CONF_APP_KEY, DOMAIN, config_flow
...
def mock_aioambient(get_devices_response):
    ...
    with patch("openpeerpower.components.ambient_station.config_flow.Client") as Client:
