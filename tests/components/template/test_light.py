...
class TestTemplateLight:
   ...
   opp = None
    ...
    def setup_method(self, method):
        ...
        self.opp.services.register("test", "automation", record_call)
    ...
    def test_template_state_text(self):
        ...
        state = self.opp.states.set("light.test_state", STATE_ON)
        self.opp.block_till_done()

        state = self.opp.states.get("light.test_template_light")
        assert state.state == STATE_ON

        state = self.opp.states.set("light.test_state", STATE_OFF)
        self.opp.block_till_done()
    ...
    def test_no_lights_does_not_create(self):
        ...
        with assert_setup_component(0, "light"):
            assert setup.setup_component(
                self.opp, "light", {"light": {"platform": "template"}}
            )
    ...
    def test_missing_key(self, missing_key, count):
        ...
        with assert_setup_component(count, "light"):
            assert setup.setup_component(self.opp, "light", light)
        self.opp.block_till_done()
        self.opp.start()
        self.opp.block_till_done()
    ...
    def test_on_action(self):
        ...
        self.opp.states.set("light.test_state", STATE_OFF)
        self.opp.block_till_done()

        state = self.opp.states.get("light.test_template_light")
        assert state.state == STATE_OFF

        common.turn_on(self.opp, "light.test_template_light")
        self.opp.block_till_done()
    ...
    def test_off_action(self):
        ...
        self.opp.states.set("light.test_state", STATE_ON)
        self.opp.block_till_done()

        state = self.opp.states.get("light.test_template_light")
        assert state.state == STATE_ON

        common.turn_off(self.opp, "light.test_template_light")
        self.opp.block_till_done()
    ...
    def test_level_action_no_template(self):
        ...
        common.turn_on(self.opp, "light.test_template_light", **{ATTR_BRIGHTNESS: 124})
        self.opp.block_till_done()
        assert len(self.calls) == 1
    ...
    def test_temperature_action_no_template(self):
        ...
        common.turn_on(self.opp, "light.test_template_light", **{ATTR_COLOR_TEMP: 345})
        self.opp.block_till_done()
        assert len(self.calls) == 1
    ...
    def test_color_action_no_template(self):
        ...
        common.turn_on(
            self.opp, "light.test_template_light", **{ATTR_HS_COLOR: (40, 50)}
        )
        self.opp.block_till_done()
