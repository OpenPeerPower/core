...
def mock_scan_fixture():
    """Mock pyatv.scan."""
    with patch("openpeerpower.components.apple_tv.config_flow.scan") as mock_scan:
...
def dmap_pin_fixture():
    """Mock pyatv.scan."""
    with patch("openpeerpower.components.apple_tv.config_flow.randrange") as mock_pin:
...
def pairing():
    """Mock pyatv.scan."""
    with patch("openpeerpower.components.apple_tv.config_flow.pair") as mock_pair:
