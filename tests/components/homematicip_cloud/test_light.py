...
async def test_hmip_light.opp, default_mock_op._factory):
...
async def test_hmip_notification_light.opp, default_mock_op._factory):
...
async def test_hmip_dimmer.opp, default_mock_op._factory):
...
async def test_hmip_light_measuring.opp, default_mock_op._factory):
...
async def test_hmip_wired_multi_dimmer.opp, default_mock_op._factory):
