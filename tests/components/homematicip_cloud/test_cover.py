...
async def test_hmip_cover_shutter.opp, default_mock_op._factory):
...
async def test_hmip_cover_slats.opp, default_mock_op._factory):
...
async def test_hmip_multi_cover_slats.opp, default_mock_op._factory):
    """Test HomematicipCoverSlats."""
...
async def test_hmip_blind_module.opp, default_mock_op._factory):
...
async def test_hmip_garage_door_tormatic.opp, default_mock_op._factory):
    """Test HomematicipCoverShutte."""
...
async def test_hmip_garage_door_hoermann.opp, default_mock_op._factory):
    """Test HomematicipCoverShutte."""
...
async def test_hmip_cover_shutter_group.opp, default_mock_op._factory):
    """Test HomematicipCoverShutteGroup."""
    entity_id = "cover.rollos_shuttergroup"
    entity_name = "Rollos ShutterGroup"
    device_model = None
    mock_op. = await default_mock_op._factory.async_get_mock_op.(test_groups=["Rollos"])
...
async def test_hmip_cover_slats_group.opp, default_mock_op._factory):
