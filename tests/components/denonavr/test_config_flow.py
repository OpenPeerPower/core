...
def denonavr_connect_fixture():
    ...
    with patch(
        "openpeerpower.components.denonavr.receiver.denonavr.DenonAVR._update_input_func_list",
        return_value=True,
    ), patch(
        "openpeerpower.components.denonavr.receiver.denonavr.DenonAVR._get_receiver_name",
        return_value=TEST_NAME,
    ), patch(
        "openpeerpower.components.denonavr.receiver.denonavr.DenonAVR._get_support_sound_mode",
        return_value=True,
    ), patch(
        "openpeerpower.components.denonavr.receiver.denonavr.DenonAVR._update_avr_2016",
        return_value=True,
    ), patch(
        "openpeerpower.components.denonavr.receiver.denonavr.DenonAVR._update_avr",
        return_value=True,
    ), patch(
        "openpeerpower.components.denonavr.receiver.denonavr.DenonAVR.get_device_info",
        return_value=True,
    ), patch(
        "openpeerpower.components.denonavr.receiver.denonavr.DenonAVR.name",
        TEST_NAME,
    ), patch(
        "openpeerpower.components.denonavr.receiver.denonavr.DenonAVR.model_name",
        TEST_MODEL,
    ), patch(
        "openpeerpower.components.denonavr.receiver.denonavr.DenonAVR.serial_number",
        TEST_SERIALNUMBER,
    ), patch(
        "openpeerpower.components.denonavr.receiver.denonavr.DenonAVR.manufacturer",
        TEST_MANUFACTURER,
    ), patch(
