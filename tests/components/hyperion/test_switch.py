...
async def test_switch_turn_on_off(opp: OpenPeerPower) -> None:
...
async def test_switch_has_correct_entities(opp: OpenPeerPower) -> None:
...
async def test_switches_can_be_enabled(opp: OpenPeerPower) -> None:
