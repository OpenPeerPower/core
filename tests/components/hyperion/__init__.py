...
from openpeerpower.components.hyperion import get_hyperion_unique_id
...
async def setup_test_config_entry(
    ...
    config_entry = config_entry or add_test_config_entry(opp, options=options)
...
def register_test_entity(
    opp: OpenPeerPower, domain: str, type_name: str, entity_id: str
) -> None:
