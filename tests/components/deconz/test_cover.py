...
async def test_cover(opp, aioclient_mock, mock_deconz_websocket):
    ...
    assert not opp.states.get("cover.unsupported_cover")
...
async def test_tilt_cover(opp, aioclient_mock):
    ...
    covering_device = opp.states.get("cover.covering_device")
