...
from openpeerpower.components.deconz.const import CONF_GESTURE, DOMAIN as DECONZ_DOMAIN
from openpeerpower.components.deconz.deconz_event import (
...
async def test_humanifying_deconz_alarm_event(opp, aioclient_mock):
