...
async def test_api_ping(oppio_op.dler, aioclient_mock):
...
async def test_api_ping_error(oppio_op.dler, aioclient_mock):
...
async def test_api_ping_exeption(oppio_op.dler, aioclient_mock):
...
async def test_api_info(oppio_op.dler, aioclient_mock):
...
async def test_api_host_info(oppio_op.dler, aioclient_mock):
...
async def test_api_supervisor_info(oppio_op.dler, aioclient_mock):
...
async def test_api_os_info(oppio_op.dler, aioclient_mock):
...
async def test_api_addon_info(oppio_op.dler, aioclient_mock):
...
async def test_api_discovery_message(oppio_op.dler, aioclient_mock):
...
async def test_api_retrieve_discovery(oppio_op.dler, aioclient_mock):
    """Test setup with API discovery message."""
    aioclient_mock.get(
...
async def test_api_ingress_panels(oppio_op.dler, aioclient_mock):
