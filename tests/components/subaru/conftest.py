...
from openpeerpower.const import CONF_DEVICE_ID, CONF_PASSWORD, CONF_PIN, CONF_USERNAME
...
MOCK_API = "openpeerpower.components.subaru.SubaruAPI."
...
def advance_time_to_next_fetch(opp):
