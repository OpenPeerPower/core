...
@respx.mock
async def test_multiple_rest_endpoints(opp):
    ...
    assert opp.states.get("sensor.json_date").state == "03-17-2021"
    assert opp.states.get("sensor.json_date_time").state == "07:11:08 PM"
    assert opp.states.get("sensor.json_time").state == "07:11:39 PM"
    assert opp.states.get("binary_sensor.binary_sensor").state == "on"
