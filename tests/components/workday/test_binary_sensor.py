...
class TestWorkdaySetup:
    ...
    def test_valid_country(self):
        ...
        with pytest.raises(vol.Invalid):
            binary_sensor.valid_country("OpenPeerPowerLand")

    def test_setup_component_province(self):
        """Set up workday component."""
        with assert_setup_component(1, "binary_sensor"):
            setup_component(self.opp, "binary_sensor", self.config_province)
            self.opp.block_till_done()

        entity = self.opp.states.get("binary_sensor.workday_sensor")
    ...
    def test_setup_component_noprovince(self):
        """Set up workday component."""
        with assert_setup_component(1, "binary_sensor"):
            setup_component(self.opp, "binary_sensor", self.config_noprovince)
            self.opp.block_till_done()
    ...
    def test_public_holiday_state(self, mock_date):
        """Test if public holidays are reported correctly."""
        with assert_setup_component(1, "binary_sensor"):
            setup_component(self.opp, "binary_sensor", self.config_state)
    ...
    def test_public_holiday_nostate(self, mock_date):
        """Test if public holidays are reported correctly."""
        with assert_setup_component(1, "binary_sensor"):
            setup_component(self.opp, "binary_sensor", self.config_nostate)
    ...
    def test_setup_component_invalidprovince(self):
        """Set up workday component."""
        with assert_setup_component(1, "binary_sensor"):
            setup_component(self.opp, "binary_sensor", self.config_invalidprovince)
    ...
    def test_public_holiday_includeholiday(self, mock_date):
        """Test if public holidays are reported correctly."""
        with assert_setup_component(1, "binary_sensor"):
            setup_component(self.opp, "binary_sensor", self.config_includeholiday)
    ...
    def test_tomorrow(self, mock_date):
        ...
        with assert_setup_component(1, "binary_sensor"):
            setup_component(self.opp, "binary_sensor", self.config_tomorrow)
    ...
    def test_day_after_tomorrow(self, mock_date):
        ...
        with assert_setup_component(1, "binary_sensor"):
            setup_component(self.opp, "binary_sensor", self.config_day_after_tomorrow)
    ...
    def test_yesterday(self, mock_date):
        ...
        with assert_setup_component(1, "binary_sensor"):
            setup_component(self.opp, "binary_sensor", self.config_yesterday)
    ...
    def test_config_example1_holiday(self, mock_date):
        """Test if public holidays are reported correctly."""
        with assert_setup_component(1, "binary_sensor"):
            setup_component(self.opp, "binary_sensor", self.config_example1)
    ...
    def test_config_example2_tue(self, mock_date):
        """Test if public holidays are reported correctly."""
        with assert_setup_component(1, "binary_sensor"):
            setup_component(self.opp, "binary_sensor", self.config_example2)
    ...
    def test_config_remove_holidays_xmas(self, mock_date):
        ...
        with assert_setup_component(1, "binary_sensor"):
            setup_component(self.opp, "binary_sensor", self.config_remove_holidays)
