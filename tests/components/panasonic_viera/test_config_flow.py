...
from openpeerpower.const import CONF_HOST, CONF_NAME, CONF_PIN, CONF_PORT
...
def panasonic_viera_setup_fixture():
    ...
    with patch(
        "openpeerpower.components.panasonic_viera.async_setup", return_value=True
    ), patch(
        "openpeerpower.components.panasonic_viera.async_setup_entry",
        return_value=True,
    ):
        yield
