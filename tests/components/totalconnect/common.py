...
from openpeerpower.components.totalconnect.const import CONF_USERCODES, DOMAIN
...
async def setup_platform(opp, platform):
    ...
    with patch("openpeerpower.components.totalconnect.PLATFORMS", [platform]), patch(
