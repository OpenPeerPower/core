...
from openpeerpower.components.heos import DOMAIN
...
def controller_fixture(
    ...
    with patch("openpeerpower.components.heos.Heos", new=mock), patch(
        "openpeerpower.components.heos.config_flow.Heos", new=mock
    ):
        yield mock_heos
