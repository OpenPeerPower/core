...
PATCH_CONNECTION = "openpeerpower.components.insteon.config_flow.async_connect"
PATCH_ASYNC_SETUP = "openpeerpower.components.insteon.async_setup"
PATCH_ASYNC_SETUP_ENTRY = "openpeerpower.components.insteon.async_setup_entry"
