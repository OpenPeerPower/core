...
from openpeerpower.components.tellduslive import (
    APPLICATION_NAME,
    DOMAIN,
    KEY_SCAN_INTERVAL,
    SCAN_INTERVAL,
...
from openpeerpower.config_entries import SOURCE_DISCOVERY
...
def mock_tellduslive(supports_local_api, authorize):
    """Mock tellduslive."""
    with patch(
        "openpeerpower.components.tellduslive.config_flow.Session"
    ) as Session, patch(
        "openpeerpower.components.tellduslive.config_flow.supports_local_api"
