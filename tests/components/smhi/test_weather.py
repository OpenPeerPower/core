...
from openpeerpower.components.smhi import weather as weather_smhi
from openpeerpower.components.smhi.const import ATTR_SMHI_CLOUDINESS
...
async def test_setup.opp.opp: OpenPeerPower, aioclient_mock) -> None:
