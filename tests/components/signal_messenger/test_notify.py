...
import openpeerpower.components.signal_messenger.notify as signalmessenger
...
class TestSignalMesssenger(unittest.TestCase):
    ...
    def test_send_message(self, mock):
        ...
        with self.assertLogs(
            "openpeerpower.components.signal_messenger.notify", level="DEBUG"
        ) as context:
    ...
    def test_send_message_should_show_deprecation_warning(self, mock):
        ...
        with self.assertLogs(
            "openpeerpower.components.signal_messenger.notify", level="WARNING"
        ) as context:
