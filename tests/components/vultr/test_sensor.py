...
from openpeerpower.components.vultr import CONF_SUBSCRIPTION
import openpeerpower.components.vultr.sensor as vultr
...
class TestVultrSensorSetup(unittest.TestCase):
    ...
    def test_sensor(self, mock):
        ...
        for config in self.configs:
            setup = vultr.setup_platform(self.opp, config, self.add_entities, None)
