...
from openpeerpower.components.soundtouch import media_player as soundtouch
from openpeerpower.components.soundtouch.const import DOMAIN
from openpeerpower.components.soundtouch.media_player import (
...
def one_device_fixture():
    ...
    device_1 = MockDevice()
    device_patch = patch(
        "openpeerpower.components.soundtouch.media_player.soundtouch_device",
