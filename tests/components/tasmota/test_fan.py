...
async def test_sending_mqtt_commands(opp, mqtt_mock, setup_tasmota):
    ...
    await common.async_set_percentage(opp, "fan.tasmota", 0)
    mqtt_mock.async_publish.assert_called_once_with(
        "tasmota_49A3BC/cmnd/FanSpeed", "0", 0, False
    )
    mqtt_mock.async_publish.reset_mock()
    ...
    # Set speed percentage and verify MQTT message is sent
    await common.async_set_percentage(opp, "fan.tasmota", 15)
    mqtt_mock.async_publish.assert_called_once_with(
        "tasmota_49A3BC/cmnd/FanSpeed", "1", 0, False
    )
    mqtt_mock.async_publish.reset_mock()
    ...
    # Set speed percentage and verify MQTT message is sent
    await common.async_set_percentage(opp, "fan.tasmota", 50)
    mqtt_mock.async_publish.assert_called_once_with(
        "tasmota_49A3BC/cmnd/FanSpeed", "2", 0, False
    )
    mqtt_mock.async_publish.reset_mock()
    ...
    # Set speed percentage and verify MQTT message is sent
    await common.async_set_percentage(opp, "fan.tasmota", 90)
    mqtt_mock.async_publish.assert_called_once_with(
        "tasmota_49A3BC/cmnd/FanSpeed", "3", 0, False
    )
