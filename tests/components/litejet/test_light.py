...
class TestLiteJetLight(unittest.TestCase):
    ...
    def light(self):
        ...
        return self.opp.states.get(ENTITY_LIGHT)

    def other_light(self):
        """Test the other light."""
        return self.opp.states.get(ENTITY_OTHER_LIGHT)
    ...
    def test_on_brightness(self):
        ...
        assert not light.is_on(self.opp, ENTITY_LIGHT)

        common.turn_on(self.opp, ENTITY_LIGHT, brightness=102)
        self.opp.block_till_done()
    ...
    def test_on_off(self):
        ...
        common.turn_on(self.opp, ENTITY_LIGHT)
        self.opp.block_till_done()
        self.mock_lj.activate_load.assert_called_with(ENTITY_LIGHT_NUMBER)

        common.turn_off(self.opp, ENTITY_LIGHT)
        self.opp.block_till_done()
    ...
    def test_activated_event(self):
        ...
        assert light.is_on(self.opp, ENTITY_LIGHT)
        assert not light.is_on(self.opp, ENTITY_OTHER_LIGHT)
        ...
        assert light.is_on(self.opp, ENTITY_OTHER_LIGHT)
        assert light.is_on(self.opp, ENTITY_LIGHT)
        assert self.light().state == "on"
