...
from openpeerpower.components import camera, microsoft_face as mf
from openpeerpower.components.microsoft_face import (
    ATTR_CAMERA_ENTITY,
    ATTR_GROUP,
    ATTR_PERSON,
    DOMAIN,
...
class TestMicrosoftFaceSetup:
    ...
    def test_setup_component(self, mock_update):
        ...
        with assert_setup_component(3, mf.DOMAIN):
            setup_component(self.opp, mf.DOMAIN, self.config)
    ...
    def test_setup_component_wrong_api_key(self, mock_update):
        ...
        with assert_setup_component(0, mf.DOMAIN):
            setup_component(self.opp, mf.DOMAIN, {mf.DOMAIN: {}})
    ...
    def test_setup_component_test_service(self, mock_update):
        ...
        assert self.opp.services.has_service(mf.DOMAIN, "create_group")
        assert self.opp.services.has_service(mf.DOMAIN, "delete_group")
        assert self.opp.services.has_service(mf.DOMAIN, "train_group")
        assert self.opp.services.has_service(mf.DOMAIN, "create_person")
        assert self.opp.services.has_service(mf.DOMAIN, "delete_person")
        assert self.opp.services.has_service(mf.DOMAIN, "face_person")
    ...
    def test_setup_component_test_entities(self, aioclient_mock):
        ...
        entity_group1 = self.opp.states.get("microsoft_face.test_group1")
        entity_group2 = self.opp.states.get("microsoft_face.test_group2")
    ...
    def test_service_groups(self, mock_update, aioclient_mock):
        ...
        create_group(self.opp, "Service Group")
        self.opp.block_till_done()

        entity = self.opp.states.get("microsoft_face.service_group")
        assert entity is not None
        assert len(aioclient_mock.mock_calls) == 1

        delete_group(self.opp, "Service Group")
        self.opp.block_till_done()
    ...
    def test_service_person(self, aioclient_mock):
        ...
        create_person(self.opp, "test group1", "Hans")
        self.opp.block_till_done()
        ...
        delete_person(self.opp, "test group1", "Hans")
        self.opp.block_till_done()
    ...
    def test_service_train(self, mock_update, aioclient_mock):
        ...
        train_group(self.opp, "Service Group")
        self.opp.block_till_done()
    ...
    def test_service_face(self, camera_mock, aioclient_mock):
        ...
        face_person(self.opp, "test_group2", "David", "camera.demo_camera")
        self.opp.block_till_done()
