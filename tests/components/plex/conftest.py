...
from openpeerpower.components.plex.const import DOMAIN, PLEX_SERVER_CONFIG, SERVERS
...
def mock_websocket():
    ...
    with patch("openpeerpower.components.plex.PlexWebsocket", autospec=True) as ws:
        yield ws
