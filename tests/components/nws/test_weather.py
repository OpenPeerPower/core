...
async def test_imperial_metric(
    opp, units, result_observation, result_forecast, mock_simple_nws, no_sensor
):
...
async def test_none_values(opp, mock_simple_nws, no_sensor):
...
async def test_none(opp, mock_simple_nws, no_sensor):
...
async def test_error_station(opp, mock_simple_nws, no_sensor):
...
async def test_entity_refresh(opp, mock_simple_nws, no_sensor):
    """Test manual refresh."""
    instance = mock_simple_nws.return_value
...
async def test_error_observation(opp, mock_simple_nws, no_sensor):
...
async def test_error_forecast(opp, mock_simple_nws, no_sensor):
...
async def test_error_forecast_hourly(opp, mock_simple_nws, no_sensor):
...
async def test_forecast_hourly_disable_enable(opp, mock_simple_nws, no_sensor):
    """Test error during update forecast hourly."""
    entry = MockConfigEntry(
        domain=nws.DOMAIN,
        data=NWS_CONFIG,
