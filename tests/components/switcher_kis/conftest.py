...
def mock_bridge_fixture() -> Generator[None, Any, None]:
    ...
    patchers = [
        patch(
            "openpeerpower.components.switcher_kis.SwitcherV2Bridge.start",
            new=mock_bridge,
        ),
        patch(
            "openpeerpower.components.switcher_kis.SwitcherV2Bridge.stop",
            new=mock_bridge,
        ),
        patch(
            "openpeerpower.components.switcher_kis.SwitcherV2Bridge.queue",
            get=mock_queue,
        ),
        patch(
            "openpeerpower.components.switcher_kis.SwitcherV2Bridge.running",
            return_value=True,
        ),
    ]
...
def mock_api_fixture() -> Generator[AsyncMock, Any, None]:
    ...
    patchers = [
        patch(
            "openpeerpower.components.switcher_kis.switch.SwitcherV2Api.connect",
            new=mock_api,
        ),
        patch(
            "openpeerpower.components.switcher_kis.switch.SwitcherV2Api.disconnect",
            new=mock_api,
        ),
    ]
