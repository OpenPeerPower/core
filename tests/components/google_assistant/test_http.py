...
from openpeerpower.components.google_assistant import GOOGLE_ASSISTANT_SCHEMA
from openpeerpower.components.google_assistant.const import (
    HOMEGRAPH_TOKEN_URL,
    REPORT_STATE_BASE_URL,
)
from openpeerpower.components.google_assistant.http import (
    GoogleConfig,
    _get_homegraph_jwt,
...
async def test_update_access_token.opp):
    ...
    with patch(
        "openpeerpower.components.google_assistant.http._get_homegraph_token"
    ) as mock_get_token, patch(
        "openpeerpower.components.google_assistant.http._get_homegraph_jwt"
