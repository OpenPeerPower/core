...
from openpeerpower.components.demo.binary_sensor import DemoBinarySensor
from openpeerpower.components.demo.cover import DemoCover
from openpeerpower.components.demo.light import LIGHT_EFFECT_LIST, DemoLight
from openpeerpower.components.demo.media_player import AbstractDemoPlayer
from openpeerpower.components.demo.switch import DemoSwitch
from openpeerpower.components.google_assistant import (
...
from openpeerpowerr.core import EVENT_CALL_SERVICE, State
...
async def test_sync_message.opp):
    ...
    await light.async_update_op.state()
...
async def test_serialize_input_boolean.opp):
    ...
    entity = sh.GoogleEntity.opp, BASIC_CONFIG, state)
...
async def test_device_class_switch.opp, device_class, google_type):
    ...
    await sensor.async_update_op.state()
