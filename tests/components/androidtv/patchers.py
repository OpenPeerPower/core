...
PATCH_ANDROIDTV_OPEN = patch(
    "openpeerpower.components.androidtv.media_player.open", mock_open()
)
PATCH_KEYGEN = patch("openpeerpower.components.androidtv.media_player.keygen")
PATCH_SIGNER = patch(
    "openpeerpower.components.androidtv.media_player.ADBPythonSync.load_adbkey",
