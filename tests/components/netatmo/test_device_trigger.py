...
from openpeerpower.components.netatmo import DOMAIN as NETATMO_DOMAIN
...
from openpeerpower.components.netatmo.device_trigger import SUBTYPES
...
async def test_get_triggers(
    opp, device_reg, entity_reg, platform, device_type, event_types
):
...
async def test_if_fires_on_event(
    opp, calls, device_reg, entity_reg, platform, camera_type, event_type
):
    ...
    events = async_capture_events(opp, "netatmo_event")
...
async def test_if_fires_on_event_with_subtype(
    opp, calls, device_reg, entity_reg, platform, camera_type, event_type, sub_type
):
    """Test for event triggers firing."""
    mac_address = "12:34:56:AB:CD:EF"
    connection = (device_registry.CONNECTION_NETWORK_MAC, mac_address)
...
async def test_if_invalid_device(
    opp, device_reg, entity_reg, platform, device_type, event_type
):
    """Test for event triggers firing."""
    mac_address = "12:34:56:AB:CD:EF"
    connection = (device_registry.CONNECTION_NETWORK_MAC, mac_address)
