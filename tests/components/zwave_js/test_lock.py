...
from openpeerpower.components.zwave_js.const import DOMAIN as ZWAVE_JS_DOMAIN
from openpeerpower.components.zwave_js.lock import (
    SERVICE_CLEAR_LOCK_USERCODE,
    SERVICE_SET_LOCK_USERCODE,
)
from openpeerpower.const import ATTR_ENTITY_ID, STATE_LOCKED, STATE_UNLOCKED
