...
from openpeerpower.helpers.device_registry import async_get as async_get_device_registry
...
def mock_addon_info(addon_info_side_effect):
    ...
    with patch(
        "openpeerpower.components.zwave_js.addon.async_get_addon_info",
...
def mock_set_addon_options(set_addon_options_side_effect):
    ...
    with patch(
        "openpeerpower.components.zwave_js.addon.async_set_addon_options",
...
def mock_install_addon():
    """Mock install add-on."""
    with patch(
        "openpeerpower.components.zwave_js.addon.async_install_addon"
    ) as install_addon:
        yield install_addon
...
def mock_update_addon():
    """Mock update add-on."""
    with patch(
        "openpeerpower.components.zwave_js.addon.async_update_addon"
    ) as update_addon:
        yield update_addon
...
def mock_start_addon(start_addon_side_effect):
    """Mock start add-on."""
    with patch(
        "openpeerpower.components.zwave_js.addon.async_start_addon",
...
def stop_addon_fixture():
    """Mock stop add-on."""
    with patch(
        "openpeerpower.components.zwave_js.addon.async_stop_addon"
    ) as stop_addon:
        yield stop_addon
...
def uninstall_addon_fixture():
    ...
    with patch(
        "openpeerpower.components.zwave_js.addon.async_uninstall_addon"
    ) as uninstall_addon:
...
def create_snapshot_fixture():
    ...
    with patch(
        "openpeerpower.components.zwave_js.addon.async_create_snapshot"
    ) as create_shapshot:
...
async def device_registry_fixture(opp):
    ...
    return async_get_device_registry(opp)
...
def mock_client_fixture(controller_state, version_state):
    ...
    with patch(
        "openpeerpower.components.zwave_js.ZwaveClient", autospec=True
    ) as client_class:
