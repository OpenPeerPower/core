...
async def test_scenes(opp, hank_binary_switch, integration, client):
    ...
    events = async_capture_events(opp, "zwave_js_value_notification")
...
async def test_notifications(opp, hank_binary_switch, integration, client):
    ...
    # just pick a random node to fake the value notification events
    node = hank_binary_switch
    events = async_capture_events(opp, "zwave_js_notification")
...
async def test_value_updated(opp, vision_security_zl7432, integration, client):
    """Test value updated events."""
    node = vision_security_zl7432
    events = async_capture_events(opp, "zwave_js_value_updated")
