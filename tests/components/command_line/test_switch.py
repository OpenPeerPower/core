...
async def test_state_none(opp: OpenPeerPowerType) -> None:
...
async def test_state_json_value(opp: OpenPeerPowerType) -> None:
...
async def test_state_code(opp: OpenPeerPowerType) -> None:
...
async def test_name_is_set_correctly(opp: OpenPeerPowerType) -> None:
...
async def test_switch_command_state_fail(caplog: Any, opp: OpenPeerPowerType) -> None:
...
async def test_no_switches(caplog: Any, opp: OpenPeerPowerType) -> None:
