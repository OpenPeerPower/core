...
from openpeerpower.components.pi_hole.const import CONF_LOCATION, CONF_STATISTICS_ONLY
...
def _patch_init_hole(mocked_hole):
    return patch("openpeerpower.components.pi_hole.Hole", return_value=mocked_hole)


def _patch_config_flow_hole(mocked_hole):
    return patch(
        "openpeerpower.components.pi_hole.config_flow.Hole", return_value=mocked_hole
    )
