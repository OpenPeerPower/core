...
from openpeerpower.components.climate import DOMAIN as PLATFORM_DOMAIN
...
from openpeerpower.components.dyson.climate import (
    SUPPORT_FAN,
    SUPPORT_FAN_PCOOL,
    SUPPORT_FLAGS,
    SUPPORT_HVAC,
...
async def test_state_common.opp: OpenPeerPower, device: DysonDevice) -> None:
    ...
    attributes = opp.states.get(ENTITY_ID).attributes
