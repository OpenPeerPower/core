...
import openpeerpower.components.geo_rss_events.sensor as geo_rss_events
...
@pytest.fixture
def mock_feed():
    """Pytest fixture for openpeerpower.components.geo_rss_events.sensor.GenericFeed."""
    with patch(
        "openpeerpower.components.geo_rss_events.sensor.GenericFeed"
    ) as mock_feed:
        yield mock_feed
