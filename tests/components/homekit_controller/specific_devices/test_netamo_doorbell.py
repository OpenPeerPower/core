...
https://github.com/openpeerpower/core/issues/44596
"""
...
async def test_netamo_doorbell_setup(opp):
    """Test that a Netamo Doorbell can be correctly setup in HA."""
    accessories = await setup_accessories_from_file(opp, "netamo_doorbell.json")
    ...
    triggers = await async_get_device_automations(opp, "trigger", doorbell.device_id)
