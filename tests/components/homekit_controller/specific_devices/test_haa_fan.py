...
async def test_haa_fan_setup(opp):
    """Test that a H.A.A. fan can be correctly setup in HA."""
    accessories = await setup_accessories_from_file(opp, "haa_fan.json")
    ...
    helper = Helper(opp, "switch.haa_c718b3", pairing, accessories[0], config_entry)
