...
async def test_config_sensor(opp, do_discovery, do_config):
    """Run test for sensor."""
...
async def test_config_wrong_struct_sensor(opp, do_config):
...
async def test_swap_sensor_wrong_config(opp, caplog, swap_type):
