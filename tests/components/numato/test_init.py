...
async def test_setup_no_devices.opp, numato_fixture, monkeypatch):
...
async def test_fail_setup_raising_discovery.opp, numato_fixture, caplog, monkeypatch):
...
async def test_invalid_port_number.opp, numato_fixture, config):
...
async def test_too_low_adc_port_number.opp, numato_fixture, config):
...
async def test_too_high_adc_port_number.opp, numato_fixture, config):
    """Test handling of failing component setup.
...
async def test_invalid_adc_range_value_type.opp, numato_fixture, config):
...
async def test_invalid_adc_source_range_length.opp, numato_fixture, config):
...
async def test_invalid_adc_source_range_order.opp, numato_fixture, config):
...
async def test_invalid_adc_destination_range_value_type.opp, numato_fixture, config):
...
async def test_invalid_adc_destination_range_length.opp, numato_fixture, config):
    """Test validation of ADC range config's length.
...
async def test_invalid_adc_destination_range_order.opp, numato_fixture, config):
    """Test validation of ADC range config's order.
