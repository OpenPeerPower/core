...
from openpeerpower.components import geonetnz_quakes
from openpeerpower.components.geo_location import ATTR_SOURCE
from openpeerpower.components.geonetnz_quakes import DEFAULT_SCAN_INTERVAL, DOMAIN, FEED
from openpeerpower.components.geonetnz_quakes.geo_location import (
    ATTR_DEPTH,
    ATTR_EXTERNAL_ID,
    ATTR_LOCALITY,
    ATTR_MAGNITUDE,
