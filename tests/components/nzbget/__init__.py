...
def _patch_async_setup(return_value=True):
    return patch(
        "openpeerpower.components.nzbget.async_setup",
...
def _patch_async_setup_entry(return_value=True):
    return patch(
        "openpeerpower.components.nzbget.async_setup_entry",
        return_value=return_value,
    )
...
def _patch_history(return_value=MOCK_HISTORY):
    return patch(
        "openpeerpower.components.nzbget.coordinator.NZBGetAPI.history",
        return_value=return_value,
    )
