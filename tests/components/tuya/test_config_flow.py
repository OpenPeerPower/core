...
from openpeerpower.components.tuya.const import (
...
def tuya_fixture() -> Mock:
    """Patch libraries."""
    with patch("openpeerpower.components.tuya.config_flow.TuyaApi") as tuya:
        yield tuya
...
def tuya_setup_fixture():
    ...
    with patch("openpeerpower.components.tuya.async_setup_entry", return_value=True):
        yield
