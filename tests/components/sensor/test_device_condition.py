...
async def test_get_conditions(opp, device_reg, entity_reg, enable_custom_integrations):
...
async def test_if_state_above(opp, calls, enable_custom_integrations):
...
async def test_if_state_below(opp, calls, enable_custom_integrations):
    """Test for value conditions."""
    platform = getattr(opp.components, f"test.{DOMAIN}")
...
async def test_if_state_between(opp, calls, enable_custom_integrations):
    """Test for value conditions."""
    platform = getattr(opp.components, f"test.{DOMAIN}")
