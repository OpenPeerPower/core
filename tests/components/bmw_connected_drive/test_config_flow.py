...
from openpeerpower.components.bmw_connected_drive.config_flow import DOMAIN
from openpeerpower.components.bmw_connected_drive.const import (
    CONF_READ_ONLY,
    CONF_USE_LOCATION,
)
from openpeerpower.const import CONF_PASSWORD, CONF_REGION, CONF_USERNAME
...
async def test_full_user_flow_implementation.opp):
    ...
    with patch(
        ...
        "openpeerpower.components.bmw_connected_drive.async_setup", return_value=True
    ) as mock_setup, patch(
