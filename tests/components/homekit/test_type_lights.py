...
async def test_light_brightness(opp, hk_driver, events, supported_color_modes):
...
async def test_light_color_temperature_and_rgb_color(
    opp, hk_driver, events, supported_color_modes
):
...
async def test_light_rgb_color(opp, hk_driver, events, supported_color_modes):
