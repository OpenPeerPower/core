...
from openpeerpower.config_entries import SOURCE_IGNORE, SOURCE_IMPORT
...
async def test_setup_creates_entries_for_accessory_mode_devices(opp):
    ...
    opp.states.async_set("remote.standard", "on")
    opp.states.async_set("remote.activity", "on", {"supported_features": 4})
