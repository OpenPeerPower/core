...
from openpeerpower.components.homekit.type_humidifiers import HumidifierDehumidifier
...
async def test_humidifier(opp, hk_driver, events):
    """Test if humidifier accessory and OPP are updated accordingly."""
...
async def test_dehumidifier(opp, hk_driver, events):
    """Test if dehumidifier accessory and OPP are updated accordingly."""
    entity_id = "humidifier.test"
