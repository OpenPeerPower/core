...
import openpeerpower.components.climate as climate
import openpeerpower.components.cover as cover
from openpeerpower.components.homekit.accessories import TYPES, get_accessory
...
import openpeerpower.components.media_player.const as media_player_c
