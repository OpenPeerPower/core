...
from openpeerpower.components.homekit.accessories import (
    HomeAccessory,
    HomeBridge,
    HomeDriver,
)
...
from openpeerpowerr.helpers.event import TRACK_STATE_CHANGE_CALLBACKS
...
def test_home_driver():
    ...
    with patch("pyhap.accessory_driver.AccessoryDriver.pair") as mock_pair, patch(
        "openpeerpower.components.homekit.accessories.dismiss_setup_message"
    ...
    with patch("pyhap.accessory_driver.AccessoryDriver.unpair") as mock_unpair, patch(
        "openpeerpower.components.homekit.accessories.show_setup_message"
    ) as mock_show_msg:
