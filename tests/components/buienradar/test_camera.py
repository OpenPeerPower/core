...
from openpeerpower.components.buienradar.const import CONF_COUNTRY, CONF_DELTA, DOMAIN
...
async def _setup_config_entry(opp, entry):
...
async def test_fetching_url_and_caching(aioclient_mock, opp, opp_client):
    ...
    await _setup_config_entry(opp, mock_entry)
