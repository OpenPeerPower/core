...
class TestUVCSetup(unittest.TestCase):
    ...
    def test_setup_full_config(self, mock_uvc, mock_remote):
        ...
        assert setup_component(self.opp, "camera", {"camera": config})
    ...
    def test_setup_incomplete_config(self, mock_uvc):
        ...
        assert setup_component(self.opp, "camera", {"platform": "uvc", "nvr": "foo"})
        self.opp.block_till_done()
        ...
        assert setup_component(
            self.opp, "camera", {"platform": "uvc", "port": "invalid"}
        )
        self.opp.block_till_done()
