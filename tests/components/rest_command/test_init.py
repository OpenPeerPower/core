...
class TestRestCommandSetup:
    ...
    def test_setup_component(self):
        ...
        with assert_setup_component(1):
            setup_component(self.opp, rc.DOMAIN, self.config)
    ...
    def test_setup_component_test_service(self):
        ...
        assert self.opp.services.has_service(rc.DOMAIN, "test_get")
...
class TestRestCommandComponent:
    ...
    def test_setup_tests(self):
        ...
        assert self.opp.services.has_service(rc.DOMAIN, "get_test")
        assert self.opp.services.has_service(rc.DOMAIN, "post_test")
        assert self.opp.services.has_service(rc.DOMAIN, "put_test")
        assert self.opp.services.has_service(rc.DOMAIN, "delete_test")
    ...
    def test_rest_command_timeout(self, aioclient_mock):
        ...
        self.opp.services.call(rc.DOMAIN, "get_test", {})
    ...
    def test_rest_command_form_data(self, aioclient_mock):
        ...
        self.opp.services.call(rc.DOMAIN, "post_test", {})
        self.opp.block_till_done()
    ...
    def test_rest_command_delete(self, aioclient_mock):
        ...
        self.opp.services.call(rc.DOMAIN, "delete_test", {})
        self.opp.block_till_done()
    ...
    def test_rest_command_patch(self, aioclient_mock):
        ...
        self.opp.services.call(rc.DOMAIN, "patch_test", {})
        self.opp.block_till_done()
    ...
    def test_rest_command_put(self, aioclient_mock):
        ...
        self.opp.services.call(rc.DOMAIN, "put_test", {})
        self.opp.block_till_done()
    ...
    def test_rest_command_headers(self, aioclient_mock):
        ...
        with assert_setup_component(7):
            setup_component(self.opp, rc.DOMAIN, header_config_variations)
        ...
        for test_service in [
            ...
            self.opp.services.call(rc.DOMAIN, test_service, {})
