...
async def test_sensor(spa, setup_entry, opp, entity_suffix, expected_state):
    """Test simple sensors."""
...
async def test_primary_filtration(spa, spa_state, setup_entry, opp):
...
async def test_secondary_filtration(spa, spa_state, setup_entry, opp):
