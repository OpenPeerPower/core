...
from openpeerpower.components.transmission import config_flow
from openpeerpower.components.transmission.const import (
    CONF_LIMIT,
    CONF_ORDER,
    DEFAULT_LIMIT,
    DEFAULT_NAME,
...
def transmission_setup_fixture():
    ...
    with patch(
        "openpeerpower.components.transmission.async_setup_entry", return_value=True
    ):
        yield
