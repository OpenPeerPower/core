...
from openpeerpower.components.zerproc.const import (
    DATA_ADDRESSES,
...
async def test_init(opp, mock_entry):
    ...
    assert opp.data[DOMAIN]["addresses"] == {"AA:BB:CC:DD:EE:FF", "11:22:33:44:55:66"}
...
async def test_remove_entry(opp, mock_light, mock_entry):
    """Test platform setup."""
    assert opp.data[DOMAIN][DATA_ADDRESSES] == {"AA:BB:CC:DD:EE:FF"}
