...
async def test_custom_component_name(opp, enable_custom_integrations):
...
async def test_log_warning_custom_component(opp, caplog, enable_custom_integrations):
    """Test that we log a warning when loading a custom component."""

    await loader.async_get_integration(opp, "test_package")
...
async def test_custom_integration_version_not_valid(
    ...
    with pytest.raises(loader.IntegrationNotFound):
        await loader.async_get_integration(opp, "test_no_version")
...
async def test_get_integration_legacy(opp, enable_custom_integrations):
    """Test resolving integration."""
...
async def test_custom_integration_missing(opp, caplog):
